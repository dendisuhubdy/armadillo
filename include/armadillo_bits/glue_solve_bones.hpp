...
namespace solve_opts
  ...
  static const uword flag_force_sympd = uword(1u << 8);
  ...
  struct opts_force_sympd : public opts { inline opts_force_sympd() : opts(flag_force_sympd) {} };
  ...
  static const opts_force_sympd force_sympd;
  }
