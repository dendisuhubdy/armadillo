...
namespace solve_opts
  ...
  static const uword flag_no_tri      = uword(1u << 7);
  static const uword flag_refine      = uword(1u << 8);
  ...
  struct opts_no_tri      : public opts { inline opts_no_tri()      : opts(flag_no_tri     ) {} };
  ...
  static const opts_no_tri      no_tri;
